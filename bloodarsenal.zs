...
recipes.addShaped(<bloodarsenal:stasis_plate>, 
	[[cleanRoomGlass, cleanRoomGlass, cleanRoomGlass],
	[cleanRoomGlass, <bloodmagic:altar>, cleanRoomGlass], 
...
mods.bloodmagic.BloodAltar.addRecipe(<bloodarsenal:blood_diamond>, gemExquisiteDiamond, 3, 12000, 20, 20);
...
recipes.addShaped(<bloodarsenal:blood_infused_iron_pickaxe>, 
	[[<ore:ingotBloodInfusedIron>, <ore:ingotBloodInfusedIron>, <ore:ingotBloodInfusedIron>], 
...
recipes.addShaped(<bloodarsenal:blood_infused_iron_axe>, 
	[[<ore:ingotBloodInfusedIron>, <ore:ingotBloodInfusedIron>, <ore:screwTitanium>], 
	[<ore:ingotBloodInfusedIron>, <bloodarsenal:blood_infused_wooden_axe>, <ore:craftingToolScrewdriver>], 
	[<bloodarsenal:base_item:9>, <bloodmagic:blood_orb>.withTag({orb: "bloodmagic:master"}), <bloodarsenal:base_item:9>]]);
recipes.addShaped(<bloodarsenal:blood_infused_iron_axe>, 
	[[<ore:ingotBloodInfusedIron>, <ore:ingotBloodInfusedIron>, <ore:screwTitanium>], 
	[<ore:ingotBloodInfusedIron>, <bloodarsenal:blood_infused_wooden_axe>, <ore:craftingToolScrewdriver>], 
...
recipes.addShaped(<bloodarsenal:blood_infused_iron_shovel>, 
	[[<ore:screwTitanium>, <ore:ingotBloodInfusedIron>,  <ore:screwTitanium>], 
...
recipes.addShaped(<bloodarsenal:blood_infused_iron_sword>, 
	[[<ore:screwTitanium>, <ore:ingotBloodInfusedIron>, <ore:craftingToolScrewdriver>], 
	[<ore:ingotBloodInfusedIron>, <bloodarsenal:blood_infused_wooden_sword>, <ore:screwTitanium>], 
	[<bloodarsenal:base_item:9>, <bloodmagic:blood_orb>.withTag({orb: "bloodmagic:master"}), <bloodarsenal:base_item:9>]]);
recipes.addShaped(<bloodarsenal:blood_infused_iron_sword>, 
	[[<ore:screwTitanium>, <ore:ingotBloodInfusedIron>, <ore:craftingToolScrewdriver>], 
	[<ore:ingotBloodInfusedIron>, <bloodarsenal:blood_infused_wooden_sword>, <ore:screwTitanium>], 
...
recipes.addShaped(<bloodarsenal:glass_sacrificial_dagger>, 
	[[<ore:shardGlass>, <minecraft:arrow>, <ore:shardGlass>],
	[<ore:shardGlass>, <bloodmagic:sacrificial_dagger>, <ore:shardGlass>],
	[<ore:ingotBloodInfusedIron>, <bloodmagic:blood_orb>.withTag({orb: "bloodmagic:magician"}), <ore:ingotBloodInfusedIron>]]);
