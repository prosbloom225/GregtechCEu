...
mods.thaumcraft.Infusion.registerRecipe("mithminite_robe", "TAR_MITHMINITE_ROBE", <thaumadditions:mithminite_robe>, 18, 
	...
	<thaumadditions:adaminite_robe>, 
		...
		<ore:ingotMithminite>, <minecraft:ghast_tear>, gravitationEngine, <thaumicaugmentation:elytra_harness>, <thaumicaugmentation:impetus_mirror>, <thaumicaugmentation:thaumostatic_harness_augment:1>]);
// Mithminite Belt
