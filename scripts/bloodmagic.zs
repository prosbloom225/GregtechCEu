...
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("blood_altar", "", 100, 
	...
	[<ore:cobblestone>, <thaumcraft:crucible>, <ore:cobblestone>], 
...
mods.thaumcraft.Infusion.registerRecipe("rune_of_augmented_capacity", "", <bloodmagic:blood_rune:7>, 4, 
	...
	<bloodarsenal:slate:2>, 
	[drumSteel, dustEnergium, <bloodmagic:slate:2>, 
	drumSteel, dustEnergium, <bloodmagic:slate:2>,
	drumSteel, dustEnergium, <bloodmagic:slate:2>]);
...
mods.thaumcraft.Infusion.registerRecipe("rune_of_the_orb", "", <bloodmagic:blood_rune:8>, 8, 
	...
	[<bloodmagic:slate:3>, <bloodarsenal:slate:3>, dustEnergium, <bloodmagic:slate:3>,
	<ore:batteryHv>, <bloodmagic:slate:3>, <ore:batteryHv>, <bloodmagic:slate:3>, dustEnergium, <bloodarsenal:slate:3>]);
...
mods.thaumcraft.Infusion.registerRecipe("acceleration_rune", "", <bloodmagic:blood_rune:9>, 14, 
	...
	[<bloodmagic:blood_rune:5>, <bloodarsenal:blood_diamond:1>, <bloodmagic:slate:4>, dustEnergium, <bloodarsenal:slate:4>, pumpIv, 
	<bloodmagic:blood_rune:1>, <bloodarsenal:blood_diamond:1>, <bloodmagic:slate:4>, dustEnergium, <bloodarsenal:slate:4>, pumpIv]);
...
recipes.addShaped(<bloodmagic:teleposer>, 
	...
	[<ore:plateEnderPearl>, <bloodmagic:teleposition_focus>, <ore:plateEnderPearl>],
	[dustEnergium, <ore:frameGtTungstenSteel>, dustEnergium]]);
recipes.addShaped(<bloodmagic:teleposer>, 
...
mods.thaumcraft.Infusion.registerRecipe("demon_crucible", "", <bloodmagic:demon_crucible>, 12, 
	...
	[<ore:dustPlastic>, <bloodmagic:slate:2>, <ore:craftingFurnace>, 
	<ore:dustPlastic>, <bloodmagic:slate:2>, <ore:craftingFurnace>, 
	<ore:dustPlastic>, <bloodmagic:slate:2>, <ore:craftingFurnace>]);
...
mods.bloodmagic.BloodAltar.addRecipe(<bloodmagic:blood_orb>.withTag({orb: "bloodmagic:weak"}), plateAluminium, 0, 5000, 2,2);

// Apprentice Blood Orb
mods.bloodmagic.BloodAltar.removeRecipe(<minecraft:redstone_block>);
mods.bloodmagic.BloodAltar.addRecipe(<bloodmagic:blood_orb>.withTag({orb: "bloodmagic:apprentice"}), plateStainlessSteel, 1, 10000, 2,2);

// Magician Blood Orb
mods.bloodmagic.BloodAltar.removeRecipe(<minecraft:gold_block>);
mods.bloodmagic.BloodAltar.addRecipe(<bloodmagic:blood_orb>.withTag({orb: "bloodmagic:magician"}), plateTitanium, 2, 30000, 2,2);

// Master Blood Orb
mods.bloodmagic.BloodAltar.removeRecipe(<bloodmagic:blood_shard>);
mods.bloodmagic.BloodAltar.addRecipe(<bloodmagic:blood_orb>.withTag({orb: "bloodmagic:master"}), plateTungstenSteel,3, 60000, 2,2);

// Archmage Blood Orb
mods.bloodmagic.BloodAltar.removeRecipe(<minecraft:nether_star>);
mods.bloodmagic.BloodAltar.addRecipe(<bloodmagic:blood_orb>.withTag({orb: "bloodmagic:archmage"}), plateOsmium, 4, 120000, 2,2);

// Weak Activation Crystal
mods.bloodmagic.BloodAltar.removeRecipe(<bloodmagic:lava_crystal>);
mods.bloodmagic.BloodAltar.addRecipe(<bloodmagic:activation_crystal>, energyCrystal, 2, 20000, 2,2);

// Awakened Activation Crystal
recipes.remove(<bloodmagic:activation_crystal:1>);
mods.bloodmagic.BloodAltar.addRecipe(<bloodmagic:activation_crystal:1>, lapotronCrystal, 2, 120000, 2,2);
...
mods.thaumcraft.Infusion.registerRecipe("ritual_diviner", "", <bloodmagic:ritual_diviner>, 4, 
	...
	[<ore:dustTalc>, <bloodmagic:inscription_tool:1>, <ore:gemFlawlessDiamond>, <bloodmagic:inscription_tool:2>, <ore:gemFlawlessEmerald>, 
...
mods.thaumcraft.Infusion.registerRecipe("ritual_diviner_dawn", "", <bloodmagic:ritual_diviner:2>, 12, 
	...
	[<ore:gemExquisiteGlass>, <bloodmagic:slate:4>, <ore:gemExquisiteGlass>, <bloodmagic:slate:4>, 
	<ore:gemExquisiteGlass>, <bloodmagic:slate:4>, <ore:gemExquisiteGlass>, <bloodmagic:slate:4>]);
...
mods.thaumcraft.Infusion.registerRecipe("lava_crystal", "", <bloodmagic:lava_crystal>, 6, 
	...
	<ore:plateRoseGold>, 
	[<ore:blockCharcoal>, <thaumicaugmentation:fortified_glass>, <ore:gemFlawlessDiamond>, <thaumicaugmentation:fortified_glass>]);
...
mods.thaumcraft.Infusion.registerRecipe("sigil_green_grove", "", <bloodmagic:sigil_green_grove>, 8, 
	...
	<bloodmagic:component:5>, <thaumcraft:sapling_silverwood>, <bloodmagic:component:5>, <thaumcraft:sapling_greatwood>, <bloodmagic:component:5>, <minecraft:sapling>]);
...
mods.thaumcraft.Infusion.registerRecipe("sigil_compression", "", <bloodmagic:sigil_compression>, 14, 
	...
	<bloodmagic:slate:3>, 
	[<bloodmagic:slate:3>, pistonIv, craftingStation, motorIv, <bloodmagic:slate:3>, motorIv, craftingStation, pistonIv]);
...
mods.thaumcraft.Infusion.registerRecipe("sigil_ender_severance", "", <bloodmagic:sigil_ender_severance>, 14, 
	...
	<bloodmagic:slate:4>, 
	[<thaumcraft:causality_collapser>, <bloodmagic:slate:3>, quantumEye, <ore:blockSlime>, <bloodmagic:component:16>, 
	quantumEye, <bloodmagic:component:16>, <ore:blockSlime>, quantumEye, <bloodmagic:slate:3>]);
...
mods.bloodmagic.AlchemyTable.addRecipe(<bloodmagic:component:7>, 
	[<minecraft:packed_ice>, <ore:dustIce>, <bloodmagic:component:29>, 
...
mods.bloodmagic.AlchemyTable.addRecipe(<bloodmagic:component:8>,
	[<bloodmagic:ritual_controller>, <thaumcraft:tallow>, emitterHv, <ore:ingotMithrillium>], 
	1000,200,2);
...
mods.bloodmagic.AlchemyTable.addRecipe(<bloodmagic:component:12>,
	[<bloodmagic:component:28>, dustEnergium, <ore:dustUltimet>, 
	<ore:dustUltimet>, dustEnergium], 
	2000,200,2);
...
mods.bloodmagic.AlchemyTable.addRecipe(<bloodmagic:component:29>,
	[<thaumcraft:phial>, <ore:dustGlowstone>, <minecraft:gunpowder>, <minecraft:redstone>, fertilizer], 
	500,200,1);
...
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("petty_tartaric_gem", "", 100, 
	...
	[<bloodmagic:slate>, <ore:batteryMv>, <bloodmagic:slate>], 
	[<ore:screwAluminium>, <bloodmagic:slate>, <ore:screwAluminium>]]);
...
assembler.recipeBuilder()
	.inputs([<bloodmagic:component:10>, filterItem])
...
assembler.recipeBuilder()
	.inputs([<bloodmagic:component:10>, filterSmart])
...
recipes.remove(<bloodmagic:base_item_filter:1>);
assembler.recipeBuilder()
	.inputs([<bloodmagic:component:10>, filterOreDict])
	.outputs(<bloodmagic:base_item_filter:1>)
	.duration(2000).EUt(30).buildAndRegister();
...
assembler.recipeBuilder()
	.inputs([<bloodmagic:base_item_filter>, filterFluid])
